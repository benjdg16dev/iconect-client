      ...
      <div className="no-files-found-svg">
        ...
        >
          ...
          <path
            ...
            fill="#2f2e41"
          />
          <circle cx="559" cy="744.5" r="43" fill="#004d40" />
          <circle cx="54" cy="729.5" r="43" fill="#004d40" />
          <circle cx="54" cy="672.5" r="31" fill="#004d40" />
          <circle cx="54" cy="624.5" r="22" fill="#004d40" />
        </svg>
      </div>
      <div className="no-files-found-text">
        <h3>No files found.</h3>
        <span>
          We couldn't find any uploaded files.
          <br />
          Please upload by choosing a file or simply drag and drop.
        </span>
      </div>
    </div>
  );
